...
const EditDepartment = () => {
  ...
  useEffect(() => {
    const fetchDepartment = async () => {
      ...
      try {
        ...
        if (error.response) {
          alert(error.response.data?.error || "Something went wrong while fetching the department.");
        } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        alert(error.response.data?.error || "Something went wrong while updating the department.");
      } else {
        alert("Network error or server is unreachable.");
      }
    }
